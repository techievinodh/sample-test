...
var urlPath = `http://localhost:5000/getpreviewrecords?exportType=partial&filename=${queryParam2}`;
...
function prevPage() {
  ...
  // getAddressGridData(UIDArr[current_page-1]);
}
